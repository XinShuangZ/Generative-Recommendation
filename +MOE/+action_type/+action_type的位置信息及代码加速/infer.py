...
def get_candidate_emb(indexer, feat_types, feat_default_value, model):
    """
...
def infer():
    ...
    for step, batch in tqdm(enumerate(test_loader), total=len(test_loader)):
        ...
        seq, token_type, seq_feat, next_token_type, next_action_type, user_id = batch
        seq = seq.to(args.device)
        logits = model.predict(seq, seq_feat, token_type, next_token_type, next_action_type)
