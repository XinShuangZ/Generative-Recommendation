...
class BaselineModel(torch.nn.Module):
    ...
    def __init__(self, user_num, item_num, feat_statistics, feat_types, args):  #
        ...
        if self.use_action_type:
            user_dim = args.hidden_units * (len(self.USER_SPARSE_FEAT) + 2 + len(self.USER_ARRAY_FEAT)) + len(self.USER_CONTINUAL_FEAT)
        else:
    ...
    def feat2emb(self, seq, feature_array, mask=None, seq_action_types=None, include_user=False):
        ...
        if seq_action_types:
            ...
            item_feat_list.append(action_type_embedding)
    ...
    def forward(
        ...
        pos_embs = self.feat2emb(pos_seqs, pos_feature, seq_action_types=seq_action_types,include_user=False)
        neg_embs = self.feat2emb(neg_seqs, neg_feature, seq_action_types=seq_action_types,include_user=False)
